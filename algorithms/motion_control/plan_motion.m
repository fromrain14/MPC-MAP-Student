...
% Výpočet úhlu k cíli
angle_to_target = atan2(yG_r, xG_r);

% Pokud je odchylka větší než 45 stupňů, otoč se na místě
if abs(angle_to_target) > pi/4
    vR = sign(angle_to_target) * V_BASE;
    vL = -sign(angle_to_target) * V_BASE;
